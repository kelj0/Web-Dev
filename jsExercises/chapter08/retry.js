...
raises an exception of type MultiplicatorUnitFailure. Write a function 
that wraps this clunky function and just keeps trying until a 
  ...
  while(true){
    try{
       ...
       if (e instanceof MultiplicatorUnitFailure)
         console.log("primitive failed, trying again..");
       else
         throw e;
    }
  }
